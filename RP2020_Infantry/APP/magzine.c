...
//{
//	Magzine_Ctrl_t* Ctrl = &Magz->Ctrl;
//	
//	/* 关仓 */
//	if(Ctrl->Angle.feedback < Ctrl->Angle.target) 
//	{	
//		Ctrl->Angle.feedback += 5;
//		if(Ctrl->Angle.feedback > Ctrl->Angle.target) {
//			Ctrl->Angle.feedback = Ctrl->Angle.target;
//		}
//	}
//	/* 开仓 */
//	else if(Ctrl->Angle.feedback > Ctrl->Angle.target) 
//	{
//		Ctrl->Angle.feedback  -= 5;
//		if(Ctrl->Angle.feedback < Ctrl->Angle.target) {
//			Ctrl->Angle.feedback = Ctrl->Angle.target;
...
//	}
//	
//	if(Ctrl->Angle.feedback < 0) {
//		Ctrl->Angle.feedback = 0;
//	}

//	MAGZINE_PwmOut(Ctrl->Angle.feedback);
//}
