 ...
 * @brief       This file includes the USART5 driver external functions 
...
{		
	...
	xCom5DMAInit.DMA_BufferSize = JUDGE_BUFFER_LEN;
...
void UART5_init( void )
{
	...
	xNvicInit.NVIC_IRQChannelSubPriority         = UART5_IT_PRIO_SUB;
